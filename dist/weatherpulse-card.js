        ...
        <div class="section">
          ...
          <ha-formfield label="Enable Temperature Gradient Overlay">
            <ha-switch
              ...
              .checked=${!1!==this._config.enable_gradient_overlay}
              @change=${this._toggleChanged}
            ></ha-switch>
          </ha-formfield>
          <p class="helper-text">
          ...
          ${!1!==this._config.enable_gradient_overlay?j`
            <ha-textfield
              label="Gradient Overlay Opacity (%)"
              type="number"
              .configValue=${"gradient_overlay_opacity"}
              .value=${String(void 0!==this._config.gradient_overlay_opacity?this._config.gradient_overlay_opacity:10)}
              @input=${this._valueChanged}
              min="0"
              max="100"
            ></ha-textfield>
