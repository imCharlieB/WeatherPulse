...
`:""}
  ...
  <ha-selector
    .hass=${this.hass}
    .selector=${{select:{options:[{value:"forecast",label:"Forecast Only (High/Low)"},{value:"actual",label:"Actual Only (From Sensor)"},{value:"both",label:"Both (Forecast + Actual)"}]}}}
...
`:""}
        ...
        <div class="section">
          ...
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{options:[{value:"time-focused",label:"Time Focused (Large Clock)"},{value:"date-focused",label:"Date Focused (Large Date)"},{value:"balanced",label:"Balanced (Equal Time & Date)"},{value:"minimal",label:"Minimal (Icon & Temp Only)"},{value:"greeting",label:"Greeting (Personalized Message)"},{value:"graphical",label:"Graphical (Seasonal Background)"}]}}}
          ...
          ${"graphical"===this._config.header_mode?j`
            <div class="seasonal-images-section">
              ...
              <ha-selector
                .hass=${this.hass}
                .selector=${{select:{options:[{value:"default",label:"Default - Cherry Blossoms & Tulips"},{value:"/local/community/WeatherPulse/images/spring-alt1.jpg",label:"Alt 1 - More Tulips & Flowers"},{value:"/local/community/WeatherPulse/images/spring-alt2.jpg",label:"Alt 2 - Vibrant Spring Garden"}]}}}
              ...
              <ha-selector
                .hass=${this.hass}
                .selector=${{select:{options:[{value:"default",label:"Default - Tropical Beach Sunset"},{value:"/local/community/WeatherPulse/images/summer-alt1.jpg",label:"Alt 1 - Sunset Beach Painting"}]}}}
              ...
              <ha-selector
                .hass=${this.hass}
                .selector=${{select:{options:[{value:"default",label:"Default - Pumpkin & Maple Leaves"},{value:"/local/community/WeatherPulse/images/fall-alt1.jpg",label:"Alt 1 - Autumn Forest Scene"}]}}}
              ...
              <ha-selector
                .hass=${this.hass}
                .selector=${{select:{options:[{value:"default",label:"Default - Snowy Winter Beach"},{value:"/local/community/WeatherPulse/images/winter-alt1.jpg",label:"Alt 1 - Snowy Palm Tree Beach"}]}}}
          ...
          ${this._config.show_time?j`
            <ha-selector
              .hass=${this.hass}
              .selector=${{select:{options:[{value:"12h",label:"12 Hour (AM/PM)"},{value:"24h",label:"24 Hour (Military Time)"}]}}}
        ...
        <div class="section">
          ...
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{options:[{value:"daily",label:"Daily"},{value:"hourly",label:"Hourly"}]}}}
          ...
          `:j`
            <ha-selector
              .hass=${this.hass}
              .selector=${{select:{options:[{value:"5",label:"5 Days"},{value:"7",label:"7 Days"}]}}}
          ...
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{options:[{value:"compact",label:"Compact"},{value:"standard",label:"Standard"},{value:"detailed",label:"Detailed"},{value:"chart",label:"Chart (Temperature Trend Line)"}]}}}
        ...
        <div class="section">
          ...
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{options:[{value:"compact",label:"Compact (displayed in header)"},{value:"standard",label:"Standard (separate cards)"},{value:"detailed",label:"Detailed (large cards)"}]}}}
    ...
    `}};e([me({attribute:!1})],De.prototype,"hass",void 0),e([fe()],De.prototype,"_config",void 0),e([fe()],De.prototype,"_expandedSections",void 0),De=e([ce("weatherpulse-card-editor")],De);var Ue,Ne=Object.freeze({__proto__:null,get WeatherPulseCardEditor(){return De}});const Pe={halloween:{foreground:["🪦","🎃","🍬"],background:["🦇","🧛","🕷️","👻","🕸️","🕷️","🦹‍♂️","🧟"],lights:{colors:["#ff6b00","#9c27b0","#ff9800","#7b1fa2"],style:"round"}},christmas:{foreground:["🎄","🎁","🕯️"],background:["❄️","🔔","🦌","🎅","⛄","🌟","🧑‍🎄"],lights:{colors:["#ff0000","#00ff00","#ffff00","#0000ff","#ff69b4"],style:"long"}},newyear:{foreground:["🎊","YEAR","🍾"],background:["🍾","🥳","✨","🎉"],lights:{colors:["#FFD700","#C0C0C0","#4169E1","#FFD700","#C0C0C0","#4169E1"],style:"round"}},valentine:{foreground:["💝","🌹","💌"],background:["❤️","💕","💘","💖"]},stpatrick:{foreground:["🍀","☘️","🍻"],background:["🌈","💚","🎩","🪙"]},july4th:{foreground:["🎉","🇺🇸","🗽"],background:["🎇","⭐","🎉","🎊"],lights:{colors:["#ff0000","#ffffff","#0000ff","#ff0000","#ffffff","#0000ff"],style:"round"}},easter:{foreground:["🐰","🥚","🐇"],background:["🌷","🐣","💐","🌸"]},cincodemayo:{foreground:["🇲🇽","🌮","🍹"],background:["🌵","🎉","🎊","🎺"],lights:{colors:["#ff0000","#ffffff","#00ff00","#ff0000","#ffffff","#00ff00"],style:"round"}}};let Oe=Ue=class extends le{constructor(){super(...arguments),this.currentTime=ue(),this.currentDate=ve(),this.forecastData=[],this.hourlyForecastData=[],this.nwsAlerts=[],this.lastAlertFetch=0,this.lastForecastFetch=0,this.fireworkColorHandlers=new WeakMap,this.fireworkColorIntervals=new WeakMap}static async getConfigElement(){return await Promise.resolve().then(function(){return Ne}),document.createElement("weatherpulse-card-editor")}static getStubConfig(){return{type:"custom:weatherpulse-card",entity:"weather.home",header_mode:"time-focused",show_date:!0,show_time:!0,forecast_type:"daily",forecast_days:5,hourly_count:12,view_mode:"standard",animate_icons:!0,data_rows:["temperature","precipitation","wind"]}}setConfig(e){if(!e.entity)throw new Error("You need to define an entity");this.config={header_mode:"time-focused",show_date:!0,show_time:!0,forecast_type:"daily",forecast_days:5,hourly_count:12,view_mode:"standard",animate_icons:!0,data_rows:["temperature","precipitation"],show_forecast:!0,temp_display_mode:"forecast",...e}}connectedCallback(){super.connectedCallback(),this.startClock(),this.fetchForecast(),this.fetchNWSAlerts(),this.forecastUpdateInterval=window.setInterval(()=>this.fetchForecast(),18e5),this.alertUpdateInterval=window.setInterval(()=>this.fetchNWSAlerts(),3e5)}disconnectedCallback(){super.disconnectedCallback(),this.stopClock(),this.forecastUpdateInterval&&clearInterval(this.forecastUpdateInterval),this.alertUpdateInterval&&clearInterval(this.alertUpdateInterval),this.forecastDebounceTimer&&clearTimeout(this.forecastDebounceTimer);const e=this.shadowRoot?.querySelectorAll(".firework");e?.forEach(e=>{const t=this.fireworkColorHandlers.get(e);t&&(e.removeEventListener("animationiteration",t),this.fireworkColorHandlers.delete(e));const a=this.fireworkColorIntervals.get(e);void 0!==a&&(window.clearInterval(a),this.fireworkColorIntervals.delete(e))})}updated(e){super.updated(e);const t=this.getCurrentHoliday();"newyear"!==t&&"july4th"!==t||this.isNightModeActive()||window.requestAnimationFrame(()=>this.configureFireworks())}configureFireworks(){const e=this.shadowRoot?.querySelector(".fireworks-container");if(!e)return;const t=Array.from(e.querySelectorAll(".firework"));if(0===t.length)return;const a=this.shadowRoot?.querySelector("ha-card"),r=e.getBoundingClientRect(),i=r.height||a?.offsetHeight||320,o=r.width||a?.offsetWidth||320,n=Math.max(Math.min(o,i),200);e.classList.remove("active"),e.style.visibility="hidden";const s=[30,50,70],l=[-.2,0,.2],d=i/2;t.forEach((e,t)=>{const a=t%s.length,r=s[a],c=o*l[a],h=Math.max(d-20,Math.min(d,200)),p=Math.max(i*(.55+.04*t),180),m=Math.max(n*(.48-.06*t),.26*n),f=Math.max(.006*m,1.2);e.style.left=`${r}%`,e.style.top="50%",e.style.setProperty("--x",`calc(-50% + ${c.toFixed(2)}px)`),e.style.setProperty("--initialY",`${h.toFixed(2)}px`),e.style.setProperty("--y",`${(-p).toFixed(2)}px`),e.style.setProperty("--finalSize",`${m.toFixed(2)}px`),e.style.setProperty("--particleSize",`${f.toFixed(2)}px`),e.style.setProperty("--fw-delay",`${(.75*t).toFixed(2)}s`),this.applyRandomFireworkColors(e);const g=this.fireworkColorHandlers.get(e);g&&e.removeEventListener("animationiteration",g);const u=this.fireworkColorIntervals.get(e);void 0!==u&&window.clearInterval(u);const v=()=>this.applyRandomFireworkColors(e);this.fireworkColorHandlers.set(e,v),e.addEventListener("animationiteration",v);const b=window.setInterval(v,2100);this.fireworkColorIntervals.set(e,b)}),e.offsetHeight,e.style.visibility="visible",e.classList.add("active")}applyRandomFireworkColors(e){("july4th"===this.getCurrentHoliday()?this.generateJuly4thPalette():this.generateFireworkPalette()).forEach((t,a)=>{e.style.setProperty(`--color${a+1}`,t)})}generateFireworkPalette(){const e=Math.floor(Math.random()*Ue.FIREWORK_PALETTES.length),t=[...Ue.FIREWORK_PALETTES[e]];return this.shuffleArray(t),t.map((e,t)=>this.tweakPaletteColor(e,t))}generateJuly4thPalette(){const e=Math.floor(Math.random()*Ue.JULY4TH_PALETTES.length),t=[...Ue.JULY4TH_PALETTES[e]];return this.shuffleArray(t),t}tweakPaletteColor(e,t){const{h:a,s:r,l:i}=this.hexToHsl(e),o=(a+24*(Math.random()-.5)+3*t+360)%360,n=this.clamp(r+10*(Math.random()-.5),70,100),s=this.clamp(i+10*(Math.random()-.5),38,58);return`hsl(${Math.round(o)}deg, ${Math.round(n)}%, ${Math.round(s)}%)`}shuffleArray(e){for(let t=e.length-1;t>0;t-=1){const a=Math.floor(Math.random()*(t+1));[e[t],e[a]]=[e[a],e[t]]}}hexToHsl(e){let t=e.replace("#","");3===t.length&&(t=t.split("").map(e=>e+e).join(""));const a=parseInt(t.slice(0,2),16)/255,r=parseInt(t.slice(2,4),16)/255,i=parseInt(t.slice(4,6),16)/255,o=Math.max(a,r,i),n=Math.min(a,r,i),s=o-n;let l=0;0!==s&&(l=o===a?(r-i)/s%6:o===r?(i-a)/s+2:(a-r)/s+4),l=(60*l+360)%360;const d=(o+n)/2;return{h:l,s:100*(0===s?0:s/(1-Math.abs(2*d-1))),l:100*d}}clamp(e,t,a){return Math.min(a,Math.max(t,e))}startClock(){this.updateTime(),this.timeInterval=window.setInterval(()=>this.updateTime(),1e3)}stopClock(){this.timeInterval&&clearInterval(this.timeInterval)}updateTime(){this.currentTime=ue(),this.currentDate=ve(),(this.config.show_time||this.config.show_date)&&this.requestUpdate()}shouldUpdate(e){if(e.has("config"))return!0;if(e.has("currentTime")||e.has("currentDate"))return!0;if(e.has("hass")){const t=e.get("hass");if(!t)return!0;if(t.states[this.config.entity]!==this.hass.states[this.config.entity])return!0;if(this.config.outdoor_temp_sensor&&t.states[this.config.outdoor_temp_sensor]!==this.hass.states[this.config.outdoor_temp_sensor])return!0;if(this.config.forecast_sensor&&t.states[this.config.forecast_sensor]!==this.hass.states[this.config.forecast_sensor])return!0;const a=this.config.sun_entity||"sun.sun";if(this.config.show_weather_info?.includes("sunrise_sunset")&&t.states[a]!==this.hass.states[a])return!0;const r=this.config.moon_entity||"sensor.moon_phase";return!1!==this.config.show_moon_phase&&t.states[r]!==this.hass.states[r]}return!!(e.has("forecastData")||e.has("hourlyForecastData")||e.has("nwsAlerts"))}async fetchForecast(){this.forecastDebounceTimer&&clearTimeout(this.forecastDebounceTimer),this.forecastDebounceTimer=window.setTimeout(async()=>{const e=Date.now();if(!(e-this.lastForecastFetch<5e3)&&(this.lastForecastFetch=e,this.hass&&this.config?.entity))try{const e=this.config.forecast_type||"daily";this.hass.connection.subscribeMessage(e=>{e?.forecast&&(this.forecastData=e.forecast)},{type:"weather/subscribe_forecast",forecast_type:e,entity_id:this.config.entity}),await this.fetchHourlyForRainTiming()}catch(e){console.error("Failed to fetch forecast data:",e),this.forecastData=[]}},1e3)}async fetchHourlyForRainTiming(){const e=this.config.forecast_sensor;if(!this.hass||!e)return void(this.hourlyForecastData=[]);const t=this.hass.states[e];this.hourlyForecastData=t?.attributes?.forecast?t.attributes.forecast:[]}getWeatherData(){const e=this.hass.states[this.config.entity];if(!e)return{};const t=`${e.last_changed}_${this.forecastData.length}`;if(this.cachedWeatherData&&this.lastWeatherEntityState===t)return this.cachedWeatherData;const a=this.forecastData;return this.cachedWeatherData={temperature:e.attributes.temperature,temperature_unit:e.attributes.temperature_unit||"°F",humidity:e.attributes.humidity,pressure:e.attributes.pressure,pressure_unit:e.attributes.pressure_unit,wind_speed:e.attributes.wind_speed,wind_speed_unit:e.attributes.wind_speed_unit,wind_bearing:e.attributes.wind_bearing,wind_gust_speed:e.attributes.wind_gust_speed,condition:e.state,forecast:a,apparent_temperature:e.attributes.apparent_temperature,uv_index:e.attributes.uv_index,visibility:e.attributes.visibility,visibility_unit:e.attributes.visibility_unit,precipitation:e.attributes.precipitation,precipitation_unit:e.attributes.precipitation_unit,cloud_coverage:e.attributes.cloud_coverage,dew_point:e.attributes.dew_point,ozone:e.attributes.ozone},this.lastWeatherEntityState=t,this.cachedWeatherData}getCurrentTemp(){if(this.config.outdoor_temp_sensor){const e=this.hass.states[this.config.outdoor_temp_sensor];if(e)return parseFloat(e.state)}return this.getWeatherData().temperature||70}getSunEntity(){const e=this.config.sun_entity||"sun.sun";return this.hass.states[e]}getMoonEntity(){const e=this.config.moon_entity||"sensor.moon_phase";return this.hass.states[e]}isNightTime(){const e=this.getSunEntity();if(e)return"below_horizon"===e.state;const t=(new Date).getHours();return t>=20||t<6}getMoonPhase(){const e=this.getMoonEntity();return e?e.state:"unknown"}getRainTiming(){const e=this.hourlyForecastData;if(!e||0===e.length)return null;const t=new Date,a=new Date(t.getTime()+144e5);for(const r of e){const e=new Date(r.datetime);if(e<=t||e>a)continue;const i=(r.precipitation_probability??0)>50,o=(r.precipitation??0)>0,n=["rainy","pouring","rain","drizzle","lightning-rainy","thunderstorm","thunderstorms"].includes((r.condition||"").toLowerCase());if(i||o||n){const a=Math.round((e.getTime()-t.getTime())/36e5);let r="";return r=a<1?"Rain expected within the hour":1===a?"Rain expected in 1 hour":`Rain expected in ${a} hours`,{isRaining:!0,message:r,time:e.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}}}return null}getCurrentHoliday(){if(!this.config?.holiday_themes)return null;const e=new Date,t=e.getMonth()+1,a=e.getDate();return 10===t&&a>=25?"halloween":12===t&&a>=18&&a<=25?"christmas":12===t&&31===a||1===t&&1===a?"newyear":2!==t||13!==a&&14!==a?3===t&&17===a?"stpatrick":5===t&&5===a?"cincodemayo":7===t&&4===a?"july4th":3===t&&a>=25||4===t&&a<=5?"easter":null:"valentine"}renderHolidayDecorations(){const e=this.getCurrentHoliday();if(!e)return"";const{background:t=[]}=Pe[e]||{};let a=[],r=[];if("halloween"===e){r=[{icon:"🦇",top:8,left:8,size:2.8},{icon:"🦇",top:35,left:50,size:2.6},{icon:["🧙‍♀️","🧛","🧟"][Math.floor(Date.now()/1e4)%3],top:48,left:88,size:2.5},{icon:"🕷️",top:55,left:48,size:2.2},{icon:"🕷️",top:18,left:88,size:2},{icon:"👻",top:72,left:10,size:2.4},{icon:"🕸️",top:10,left:88,size:1.8}]}else if("christmas"===e){r=[{icon:"❄️",top:8,left:8,size:2.8},{icon:"❄️",top:10,left:90,size:2.6},{icon:"🦌",top:40,left:50,size:2.5},{icon:["🎅","🧑‍🎄"][Math.floor(Date.now()/1e4)%2],top:50,left:88,size:2.4},{icon:"⛄",top:72,left:10,size:2.2},{icon:"🌟",top:5,left:50,size:2.3},{icon:"🌟",top:75,left:88,size:2}]}else if("newyear"===e)r=[{icon:"🍾",top:8,left:8,size:2.8},{icon:"🎊",top:10,left:88,size:2.6},{icon:"🥳",top:40,left:50,size:2.5},{icon:"🍾",top:72,left:88,size:2.2},{icon:"✨",top:55,left:48,size:2.2},{icon:"🎉",top:72,left:10,size:2.2}];else if("valentine"===e)r=[{icon:"❤️",top:8,left:10,size:2.8},{icon:"❤️",top:10,left:88,size:2.6},{icon:"💕",top:40,left:50,size:2.4},{icon:"💘",top:72,left:88,size:2.2},{icon:"💖",top:72,left:10,size:2.2}];else if("july4th"===e)r=[{icon:"🇺🇸",top:8,left:10,size:2.6},{icon:"🇺🇸",top:10,left:88,size:2.4},{icon:"✨",top:40,left:50,size:2.4},{icon:"✨",top:72,left:88,size:2.2},{icon:"✨",top:72,left:10,size:2.2}];else if("stpatrick"===e)r=[{icon:"🌈",top:8,left:10,size:2.8},{icon:"🌈",top:10,left:88,size:2.6},{icon:"💚",top:40,left:50,size:2.4},{icon:"🎩",top:55,left:88,size:2.2},{icon:"🪙",top:72,left:10,size:2.2}];else if("easter"===e)r=[{icon:"🌷",top:8,left:10,size:2.8},{icon:"🌷",top:10,left:88,size:2.6},{icon:"🐣",top:40,left:50,size:2.4},{icon:"💐",top:72,left:88,size:2.2},{icon:"🌸",top:72,left:10,size:2.2}];else if("cincodemayo"===e)r=[{icon:"🌵",top:8,left:10,size:2.8},{icon:"🌵",top:10,left:88,size:2.6},{icon:"🎺",top:40,left:50,size:2.4},{icon:"🎉",top:72,left:10,size:2.2},{icon:"🎊",top:55,left:88,size:2}];else{const e=Math.min(5,t.length);a=t.slice(0,e);const i=[{top:5,left:5},{top:5,left:85},{top:45,left:5},{top:45,left:85},{top:80,left:50}];r=a.map((e,t)=>{const a=i[t%i.length];return{icon:e,top:a.top+(10*Math.random()-5),left:a.left+(10*Math.random()-5),size:1.5+1*Math.random()}})}const i=["🎆","🎇","⭐","✨"],o=r.map((e,t)=>{const a=i.includes(e.icon)?(40*Math.random()-20).toFixed(1):"0",r=(.8*t).toFixed(2);return j`
        <span
    ...
    `}async fetchNWSAlerts(){if(!this.config?.show_nws_alerts||!this.hass)return;const e=Date.now();if(!(e-this.lastAlertFetch<3e5))try{let t;if(this.config?.nws_test_mode)t="https://api.weather.gov/alerts/active?status=actual&message_type=alert",console.log("NWS Test Mode: Fetching active US alerts for display testing");else{const e=this.hass.config.latitude;t=`https://api.weather.gov/alerts/active?point=${e},${this.hass.config.longitude}`}const a=await fetch(t);if(!a.ok)return void console.warn("Failed to fetch NWS alerts:",a.status);const r=await a.json(),i=[];if(r.features&&Array.isArray(r.features)){const e=this.config?.nws_test_mode?r.features.slice(0,2):r.features;for(const t of e){const e=t.properties;e&&i.push({id:e.id||"",event:e.event||"",headline:e.headline||"",description:e.description||"",instruction:e.instruction||"",severity:e.severity||"Unknown",urgency:e.urgency||"Unknown",certainty:e.certainty||"Unknown",onset:e.onset||"",expires:e.expires||"",areaDesc:e.areaDesc||""})}}const o=i.filter((e,t,a)=>t===a.findIndex(t=>t.id===e.id||t.event===e.event&&t.headline===e.headline));this.nwsAlerts=o,this.lastAlertFetch=e,this.config?.nws_test_mode&&o.length>0&&console.log(`NWS Test Mode: Displaying ${o.length} sample alert(s)`,o)}catch(e){console.error("Failed to fetch NWS alerts:",e)}}renderNWSAlerts(){return this.config?.show_nws_alerts&&0!==this.nwsAlerts.length?j`
      <div class="nws-alerts-section">
        ${this.nwsAlerts.map(e=>{let t="alert-unknown",a="⚠️",r="";switch(e.severity){case"Extreme":t="alert-extreme",a="🔴";break;case"Severe":t="alert-severe",a="🟠";break;case"Moderate":t="alert-moderate",a="🟡";break;case"Minor":t="alert-minor",a="🔵"}return"Immediate"===e.urgency?r="IMMEDIATE":"Expected"===e.urgency&&(r="EXPECTED"),j`
              ...
              <details class="alert-main-details">
                <summary class="alert-main-summary">
                  ...
                  <span class="alert-event-compact">
                    ${e.event}
                    ${r?j`<span class="urgency-badge">${r}</span>`:""}
                  </span>
    ...
    `:j``}renderWeatherInfo(e){const t=this.config?.show_weather_info;if(!t||0===t.length)return j``;const a=this.getWeatherData(),r=e||this.config?.weather_info_layout||"standard",i=[];for(const e of t){let t="",o="",n="";switch(e){case"uv_index":void 0!==a.uv_index&&(t="☀️",o="UV Index",n=String(Math.round(a.uv_index)));break;case"wind":if(void 0!==a.wind_speed){t="💨",o="Wind";const e=a.wind_speed_unit||"mph";n=`${Math.round(a.wind_speed)} ${e}`,a.wind_gust_speed&&(n+=` (gusts ${Math.round(a.wind_gust_speed)} ${e})`)}break;case"feels_like":{let e=a.apparent_temperature;if(void 0===e&&void 0!==a.temperature){const t=a.temperature,r=a.wind_speed||0;if(t<=50&&r>3)e=35.74+.6215*t-35.75*Math.pow(r,.16)+.4275*t*Math.pow(r,.16);else if(t>=80){const r=a.humidity||50;e=2.04901523*t-42.379+10.14333127*r-.22475541*t*r-.00683783*t*t-.05481717*r*r+.00122874*t*t*r+85282e-8*t*r*r-199e-8*t*t*r*r}else e=t}if(void 0!==e){t="🌡️",o="Feels Like";const r=a.temperature_unit?.replace("°","")||"F";n=`${Math.round(e)}°${r}`}break}case"precipitation":if(void 0!==a.precipitation&&a.precipitation>0){t="💧",o="Precipitation";const e=a.precipitation_unit||"in";n=`${a.precipitation} ${e}`}break;case"humidity":void 0!==a.humidity&&(t="💧",o="Humidity",n=`${Math.round(a.humidity)}%`);break;case"pressure":if(void 0!==a.pressure){t="🔽",o="Pressure";const e=a.pressure_unit||"hPa";n=`${Math.round(a.pressure)} ${e}`}break;case"visibility":if(void 0!==a.visibility){t="👁️",o="Visibility";const e=a.visibility_unit||"mi";n=`${a.visibility} ${e}`}break;case"sunrise_sunset":{const e=this.getSunEntity();if(e&&e.attributes){const a="above_horizon"===e.state,r=a?e.attributes.next_setting:e.attributes.next_rising;if(r){t=a?"🌅":"🌄",o=a?"Sunset":"Sunrise",n=new Date(r).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}}break}}n&&("compact"===r?i.push(j`
          ...
          `))}if(0===i.length)return j``;return j`
      <div class="${`weather-info-section weather-info-layout-${r}`}">
        ${i}
      </div>
    `}renderHeader(){const e=this.getWeatherData(),t=this.getCurrentTemp(),a=e.temperature,r=!!this.config.outdoor_temp_sensor,i=ge(t,e.temperature_unit),o=this.config.header_mode||"time-focused",n=this.config.temp_display_mode||"forecast",s=e.temperature_unit||"°F";let l,d="";switch(d="both"===n&&r&&a?j`
      ...
      `,o){case"greeting":l=j`
          <div class="greeting-header">
            ...
            <div class="greeting-content">
              ...
              <div class="greeting-text">
                ${function(e,t,a){const r=new Date,i=r.getHours(),o=r.toLocaleDateString("en-US",{weekday:"short"}),n=r.toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"2-digit"}).replace(/\//g,"-"),s=e?`, ${e}`:"";let l="Hello";l=i<12?"Good Morning":i<17?"Good Afternoon":i<22?"Good Evening":"Good Night";let d="";if(t){const e=t.toLowerCase();e.includes("rain")?d="it's rainy, don't forget your umbrella":e.includes("snow")?d="it's snowy, bundle up":e.includes("clear")||e.includes("sunny")?d=a&&a>75?"it's sunny and warm":"it's a beautiful clear day":e.includes("cloud")?d="it's overcast but pleasant":e.includes("storm")&&(d="it's stormy, stay safe indoors")}return d?`${l}${s}, ${d}. ${o} ${n}`:`${l}${s}! ${o} ${n}`}(this.config.greeting_name,e.condition,t)}
              </div>
              ${d}
            </div>
          </div>
        `;break;case"graphical":{const t=be(),a=this.config.seasonal_images?.[t],r=function(e,t){if(t)return`url(${t})`;const a="/local/community/WeatherPulse/images";switch(e||be()){case"spring":default:return`url(${a}/spring-default.jpg)`;case"summer":return`url(${a}/summer-default.jpg)`;case"fall":return`url(${a}/fall-default.jpg)`;case"winter":return`url(${a}/winter-default.jpg)`}}(t,a);l=j`
          <div class="graphical-header" style="background: ${r}; background-size: cover; background-position: center;">
        ...
        `;break;default:{let i=e.condition||"clear";i=i.toLowerCase().includes("unavail")||i.toLowerCase().includes("unknown")?"Loading":i.split("-").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "),l=j`
          <div class="datetime-header time-focused-header">
            <div class="weather-icon ${ye(e.condition||"clear")}">
              ${this.renderWeatherIcon(e.condition||"clear")}
            </div>
            <div class="datetime-content">
              <div class="condition-temp">${i}, ${Math.round(a||t)}°${s.replace("°","")}</div>
              <div class="time-large">
                ${this.currentTime.replace(/\s?(AM|PM)/i,"")}<span class="time-period">${this.currentTime.match(/(AM|PM)/i)?.[0]||""}</span>
                 ${this.config.show_date?j`<div class="date-small">${this.currentDate}</div>`:""}
                </div>
             
              ${"both"===n&&r||"actual"===n&&r?j`
        ...
        `}}const c=this.getCurrentHoliday();let h="",p="";if(c){const{foreground:e=[],lights:t}=Pe[c]||{};if(h=j`
        <div class="holiday-foreground-cluster">
          ${e.map((e,t)=>{let a=e;if("YEAR"===e){const e=new Date;a=(11===e.getMonth()&&31===e.getDate()?e.getFullYear()+1:e.getFullYear()).toString()}return j`<span class="holiday-icon holiday-foreground holiday-foreground-${t} ${"YEAR"===e?"year-text":""}">${a}</span>`})}
        </div>
      `,t){p=j`
          <div class="holiday-lights">
            ${Array(12).fill(0).map((e,a)=>{const r=t.colors[a%t.colors.length],i=(.15*a).toFixed(2);return j`
                <div class="light-bulb ${"long"===t.style?"light-long":"light-round"}" style="--bulb-color: ${r}; animation-delay: ${i}s;"></div>
              `})}
          </div>
        `}}const m="compact"===(this.config?.weather_info_layout||"standard"),f=m?this.renderWeatherInfo("compact"):"";return"graphical"===o?j`
        ${p}
        ${l}
        ${h}
        ${m?j`
        ...
        `:""}
      `:j`
      <div class="card-header" style="background: ${i.color}; color: ${i.textColor}; position: relative;">
        ${p}
        ${l}
        ${h}
        ${m?j`
    ...
    `}renderWeatherIcon(e,t=!1){let a;if(t)a=function(e){const t=e.toLowerCase();return t.includes("clear")||t.includes("sunny")?"clear-day":t.includes("partlycloudy")||t.includes("partly")||t.includes("partial")?"partlycloudy":t.includes("cloud")?"cloudy":t.includes("rain")?"rainy":t.includes("snow")?"snowy":t.includes("storm")||t.includes("thunder")?"lightning":t.includes("fog")||t.includes("mist")?"fog":t.includes("wind")?"windy":"clear-day"}(e);else{const t=this.isNightTime(),r=e.toLowerCase();a=r.includes("clear")||r.includes("sunny")?t?"clear-night":"clear-day":r.includes("partlycloudy")||r.includes("partly")||r.includes("partial")?t?"partlycloudy-night":"partlycloudy":ye(e)}const r=!1!==this.config.animate_icons;if(("clear-night"===a||"partlycloudy-night"===a)&&r&&!1!==this.config.show_moon_phase){const e=this.getMoonPhase();if(e&&"unknown"!==e)return"clear-night"===a?function(e,t=!0){let a="";switch(e.toLowerCase()){case"new_moon":case"new-moon":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/></svg>';break;case"waxing_crescent":case"waxing-crescent":default:a=Me;break;case"first_quarter":case"first-quarter":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="24.26" x2="40.74" y1="18.57" y2="47.1" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/><path fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M38.8 15.87a17.48 17.48 0 00-7.12-1.58 17.37 17.37 0 01-13 29.32 13.42 13.42 0 005.93 4.23A17.68 17.68 0 0048 39.12a17.68 17.68 0 00-9.2-23.25z"/></svg>';break;case"waxing_gibbous":case"waxing-gibbous":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="24.28" x2="40.93" y1="18.15" y2="47" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/><path fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M49 27a16.78 16.78 0 00-19.45-11.9 17.2 17.2 0 011.73 4 17.76 17.76 0 01-13.82 22.19A16.83 16.83 0 0037 48.74 17.83 17.83 0 0049 27z"/></svg>';break;case"full_moon":case"full-moon":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="23.25" x2="40.75" y1="16.84" y2="47.16" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="17.5" fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"/></svg>';break;case"waning_gibbous":case"waning-gibbous":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="20.23" x2="37.75" y1="18.52" y2="48.86" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/><path fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M44.68 40.83a17.84 17.84 0 01-11.93-21.72 17.2 17.2 0 011.73-4A16.78 16.78 0 0015 27a17.83 17.83 0 0012 21.74 16.83 16.83 0 0019.58-7.45 18 18 0 01-1.9-.46z"/></svg>';break;case"last_quarter":case"third_quarter":case"last-quarter":case"third-quarter":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="19.64" x2="37.19" y1="18.96" y2="49.35" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/><path fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M29.06 33.31a17.52 17.52 0 013.26-19 17.44 17.44 0 00-7.11 1.58A17.68 17.68 0 0016 39.12a17.68 17.68 0 0023.43 8.72 13.45 13.45 0 005.94-4.23 17.51 17.51 0 01-16.31-10.3z"/></svg>';break;case"waning_crescent":case"waning-crescent":a='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="a" x1="17.54" x2="35.04" y1="20.14" y2="50.45" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#86c3db"/><stop offset=".45" stop-color="#86c3db"/><stop offset="1" stop-color="#5eafcf"/></linearGradient></defs><circle cx="32" cy="32" r="16.5" fill="none" stroke="#e5e7eb" stroke-dasharray="1.99 5.98" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(-45 32.002 31.994)"/><path fill="url(#a)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M41.25 46.82c-16.7.48-25.61-19.52-14.07-31.61h0l.08-.06a18.38 18.38 0 00-2.38.86A17.5 17.5 0 1039.12 48a18.21 18.21 0 002.23-1.19z"/></svg>'}return t||(a=a.replace(/<animate[^>]*>/g,"").replace(/<\/animate>/g,""),a=a.replace(/<animateTransform[^>]*\/>/g,"")),a=a.replace(/<svg/,'<svg class="weather-icon-svg"'),L`${_e(a)}`}(e,!0):Te(a,!0)}if(r)return Te(a,!0);return j`<span class="icon-emoji">${{"clear-day":"☀️","clear-night":"🌙",cloudy:"☁️",rainy:"🌧️",snowy:"❄️",lightning:"⛈️",fog:"🌫️",windy:"💨"}[a]||"☀️"}</span>`}renderForecast(){const e=this.getWeatherData(),t=this.config.forecast_type||"daily",a="hourly"===t?this.config.hourly_count||12:this.config.forecast_days||5,r=e.forecast?.slice(0,a)||[],i=this.config.view_mode||"standard";if(0===r.length)return j`
      ...
      `;if("chart"===i)return this.renderChartView(r,e.temperature_unit||"°F",t);return j`
      <div class="${`forecast-container forecast-${i} forecast-type-${t}`}">
        ${r.map(a=>"hourly"===t?this.renderForecastHour(a,e.temperature_unit||"°F",i):this.renderForecastDay(a,e.temperature_unit||"°F",i))}
      </div>
    `}renderForecastHour(e,t,a="standard"){const r=new Date(e.datetime).toLocaleTimeString("en-US",{hour:"numeric",hour12:!0}),i=Math.round(e.temperature||0),o=e.precipitation_probability||0,n=e.condition||"clear",s=e.humidity,l=e.wind_speed;if("compact"===a){const e=ge(i,t),a=e.color.replace("135deg","180deg");return j`
        <div class="forecast-hour forecast-compact" style="background: ${a}; color: ${e.textColor}; background-clip: padding-box;">
          <div class="hour-name">${r}</div>
          <div class="day-icon-small">
            ${this.renderWeatherIcon(n,!0)}
          </div>
          <div class="hour-temp">${i}°</div>
      ...
      `}return"detailed"===a?j`
        <div class="forecast-hour forecast-detailed">
          <div class="hour-info-row">
            ...
            <div class="hour-temp-display">${i}°</div>
          </div>
          ${o>0||s||l?j`
            <div class="hour-details">
              ${o>0?j`<div class="detail-item"><span>💧</span> ${o}%</div>`:""}
              ${s?j`<div class="detail-item"><span>💨</span> ${s}%</div>`:""}
              ${l?j`<div class="detail-item"><span>🌬️</span> ${Math.round(l)} mph</div>`:""}
            </div>
          `:""}
        </div>
      `:j`
    ...
    `}renderForecastDay(e,t,a="standard"){const r=xe(e.datetime),i=Math.round(e.temperature||0),o=Math.round(e.templow||0),n=e.precipitation_probability||0,s=e.humidity,l=e.wind_speed,d=i-o>0?o/i*70:30;if("compact"===a){const a=ge(i,t),s=a.color.replace("135deg","180deg");return j`
        <div class="forecast-day forecast-compact" style="background: ${s}; color: ${a.textColor}; background-clip: padding-box;">
          ...
          <div class="compact-temps">
            <span class="temp-high-compact">${i}°</span>
            <span class="temp-low-compact">${o}°</span>
          </div>
          ${n>0?j`<div class="precip-compact">💧${n}%</div>`:""}
        </div>
      `}if("detailed"===a){const t=e=>{if(void 0===e)return"";return["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round(e/22.5)%16]},a=void 0!==e.wind_bearing?t(e.wind_bearing):"",d=void 0!==e.precipitation&&e.precipitation>0?e.precipitation:null;return j`
        <div class="forecast-day forecast-detailed">
          ...
          <div class="detailed-temps">
            ...
            <span class="temp-item">${Ee("warmer",!1!==this.config.animate_icons)}${i}°</span>
          </div>
      ...
      <div class="forecast-day">
        ...
        <div class="day-temp-range">
          ...
          <span class="temp-high">${i}°</span>
        </div>
        ${n>0?j`
          <div class="precip-prob">${n}%</div>
        `:""}
      </div>
    `}renderChartView(e,t,a){const r=e.map(e=>"hourly"===a?e.temperature||0:[e.temperature||0,e.templow||0]).flat(),i=Math.min(...r),o=Math.max(...r),n=.3*(o-i),s=i-n,l=o+n,d=100/e.length,c=[],h=[];return e.forEach((e,t)=>{const r=Math.round(e.temperature||0),i="daily"===a?Math.round(e.templow||0):null,o=t*d+d/2,n=100-(r-s)/(l-s)*100;if(c.push(`${o.toFixed(2)},${n.toFixed(2)}`),null!==i&&i>0){const e=100-(i-s)/(l-s)*100;h.push(`${o.toFixed(2)},${e.toFixed(2)}`)}}),j`
      <div class="forecast-chart">
        ...
        <div class="chart-wrapper">
          ...
          <div class="chart-container">
            ${e.map(e=>{const t=Math.round(e.temperature||0),r="daily"===a?Math.round(e.templow||0):null,i=(t-s)/(l-s)*100,o=r?(r-s)/(l-s)*100:null;return j`
                <div class="chart-column">
                  ${r?j`
                    <div class="chart-temp chart-temp-high" style="bottom: calc(${i}% - 4px)">${t}°</div>
                    <div class="chart-point chart-point-high" style="bottom: calc(${i}% - 4px)"></div>
                    <div class="chart-temp chart-temp-low" style="bottom: calc(${o}% - 4px)">${r}°</div>
                    <div class="chart-point chart-point-low" style="bottom: calc(${o}% - 4px)"></div>
                  `:j`
                    <div class="chart-temp chart-temp-single" style="bottom: calc(${i}% - 4px)">${t}°</div>
                    <div class="chart-point chart-point-single" style="bottom: calc(${i}% - 4px)"></div>
                  `}
                </div>
              `})}
          </div>
    ...
    `}renderRainTiming(){const e=this.getRainTiming();return e?j`
    ...
    `:""}render(){if(!this.hass||!this.config)return j``;if(!this.hass.states[this.config.entity])return j`
      ...
      `;const e=this.getWeatherData(),t=e.forecast&&e.forecast.length>0,a=!1!==this.config.show_forecast&&t,r=this.isNightModeActive(),i=r?"night-mode":"",o="compact"===(this.config?.weather_info_layout||"standard"),n=this.nwsAlerts.some(e=>"Extreme"===e.severity||"Severe"===e.severity)?this.nwsAlerts.some(e=>"Extreme"===e.severity)?"alert-glow-extreme":"alert-glow-severe":"",s=this.getCurrentTemp();let l="";s>=95?l="temp-glow-hot":s<=20&&(l="temp-glow-freezing");const d=this.config?.theme||"default",c="default"!==d?`theme-${d}`:"";let h="";if("custom"===d&&this.config?.custom_theme_colors){const e=this.config.custom_theme_colors;h=`\n        --custom-primary: ${e.primary||"#667eea"};\n        --custom-secondary: ${e.secondary||"#764ba2"};\n        --custom-background: ${e.background||"#ffffff"};\n        --custom-text: ${e.text||"#333333"};\n        --custom-border: ${e.border||"#e0e0e0"};\n        --custom-accent: ${e.accent||"#f093fb"};\n      `}const p="compact"===(this.config.view_mode||"standard")?"card-content card-content-compact":"card-content",m=this.getCurrentHoliday(),f=("newyear"===m||"july4th"===m)&&!r;return j`
  <ha-card class="${i} ${n} ${l} ${c} ${m?`holiday-${m}`:""}" style="${h}">
    ...
    `}isNightModeActive(){return!(!this.config?.night_mode||!this.isNightTime())}static get styles(){return n`
      :host {
        display: block;
    ...
    `}};Oe.FIREWORK_PALETTES=[["#FF1744","#FF9100","#FFD600","#00E676","#2979FF","#D500F9"],["#FF3D00","#FFEA00","#76FF03","#00B0FF","#651FFF","#F50057"],["#FF5722","#FFC400","#64DD17","#18FFFF","#304FFE","#AA00FF"],["#FF2D55","#FF3F81","#FF9500","#34C759","#32ADE6","#AF52DE"],["#FF1744","#FF6D00","#FFEA00","#00C853","#0091EA","#AA00FF"],["#FF5252","#FFAB00","#00E5FF","#00C853","#6200EA","#FF4081"],["#FF1744","#FF6D00","#FFEA00","#00C853","#00B0FF","#AA00FF"],["#FF3D00","#F9A825","#76FF03","#00B8D4","#651FFF","#F50057"]],Oe.JULY4TH_PALETTES=[["#FF0000","#FF3333","#0033CC","#1565C0","#FF0000","#0033CC"],["#CC0000","#FF1744","#003087","#1976D2","#CC0000","#003087"],["#E53935","#FF5252","#0D47A1","#1E88E5","#E53935","#0D47A1"],["#FF0000","#B71C1C","#1A237E","#283593","#FF0000","#1A237E"]],e([me({attribute:!1})],Oe.prototype,"hass",void 0),e([fe()],Oe.prototype,"config",void 0),e([fe()],Oe.prototype,"currentTime",void 0),e([fe()],Oe.prototype,"currentDate",void 0),e([fe()],Oe.prototype,"forecastData",void 0),e([fe()],Oe.prototype,"hourlyForecastData",void 0),e([fe()],Oe.prototype,"nwsAlerts",void 0),Oe=Ue=e([ce("weatherpulse-card")],Oe),window.customCards=window.customCards||[],window.customCards.push({type:"weatherpulse-card",name:"WeatherPulse Card",description:"A modern, highly configurable weather card for Home Assistant",preview:!0,documentationURL:"https://github.com/imCharlieB/WeatherPulse"}),console.info("%c WEATHERPULSE-CARD %c v0.1.0 ","color: white; background: #4facfe; font-weight: 700;","color: #4facfe; background: white; font-weight: 700;");export{Oe as WeatherPulseCard};
