      ...
      `;case"fog":case"mist":case"foggy":return R`
        <svg class="weather-icon-svg ${a}" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <style>
            ...
            .fog-cloud-2 {
              animation: ${t?"fogFloat 10s ease-in-out infinite":"none"};
              animation-delay: 1s;
            }
            .fog-cloud-3 {
              animation: ${t?"fogFloat 9s ease-in-out infinite":"none"};
              animation-delay: 2s;
            }
            @keyframes fogFloat {
              0%, 100% { transform: translateX(0px); }
